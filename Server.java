...
public class Server {
    ...
    public void peerTwo() throws IOException {
        ...
        while (true) {
            ...
            msgFromClient = bufferedReader.readLine(); //stor
    ...
    public void startServer() {
        try {
            while(!serverSocket.isClosed()) {
                ...
                System.out.println("Anew client has connected!");
    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                if (msgFromClient != null && !msgFromClient.equals("")) { //if server message isn't empty
...
//Receives messages from android studios
import java.io.*;
import java.net.*;
